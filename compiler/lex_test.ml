...
type t = Lex.t list [@@deriving show]
...
let () =
    ...
    Test.assert_eq "match_space_char \" abc\" 0"
      (match_space_char " abc" 0)
      (Some 1) ;
    Test.assert_eq "match_space_char \" abc\" 1"
    ...
    Test.assert_eq "match_lower_char \"a \""
      (match_alph_lower_char "a " 0)
      (Some 1) ;
    Test.assert_eq "match_upper_char \"A \""
    ...
    Test.assert_eq "match_lower_ident \" abc\""
    ...
    Test.assert_eq "match_str \"hoge\" \"hoge\""
      (match_str "hoge" "hoge" 0)
      (Some 4) ;
    Test.assert_eq "match_str \"hoge\" \"hog\"" (match_str "hoge" "hog" 0) None ;
    Test.assert_eq "match_str \"hoge\" \"hogu\""
      (match_str "hoge" "hogu" 0)
      None ;
    Test.assert_eq "match_str \"hoge\" \" hoge\""
      (match_str "hoge" " hoge" 1)
      (Some 5) ;
    Test.assert_eq "match_strlit \"\"hoge\""
      (match_strlit "\"hoge\"" 0)
      (Some 6) ;
    Test.assert_eq "match_strlit \"\"ho\\\\ge\""
    ...
    Test.assert_eq "f g 0"
      (lex "f g 0" (initial_pos "test.ml"))
      [Lex.LIdent "f"; Lex.LIdent "g"; Lex.Int 0; Lex.Eof] ;
    Test.assert_eq "lex strlit and space"
      (lex " \"hoge\" \"foo\"" (initial_pos "test.ml"))
      [Lex.Str "hoge"; Lex.Str "foo"; Lex.Eof] ;
    Test.assert_eq "lex int and space"
      (lex "123 0xff" (initial_pos "test.ml"))
      [Lex.Int 123; Lex.Int 255; Lex.Eof] ;
    Test.assert_eq "lex ident and space"
      (lex "aaa bbb" (initial_pos "test.ml"))
      [Lex.LIdent "aaa"; Lex.LIdent "bbb"; Lex.Eof] ;
    Test.assert_eq "'a' '\\''"
      (lex "'a' '\\''" (initial_pos "test.ml"))
      [Lex.Char 'a'; Lex.Char '\''; Lex.Eof] ;
    Test.assert_eq "tvar 'a "
      (lex "'a" (initial_pos "test.ml"))
      [Lex.TVar "a"; Lex.Eof] ;
    Test.assert_eq "lex [x]"
      (lex "[x]" (initial_pos "test.ml"))
      [Lex.LB; Lex.LIdent "x"; Lex.RB; Lex.Eof] ;
    try
      lex
